...
mycursor.execute("CREATE TABLE temp_hashes (idha int PRIMARY KEY AUTO_INCREMENT, name varchar(81) NOT NULL UNIQUE)")
...
mycursor.execute("CREATE TABLE transactions (idta int PRIMARY KEY AUTO_INCREMENT, name varchar(81) NOT NULL UNIQUE, timestamp varchar(100) NOT NULL, idad int, address varchar(90) NOT NULL, idcl int, tag varchar(27) NOT NULL, trytes varchar(2673) NOT NULL)")
