...
def createTables(connection):
    ...
    connection.execute("ALTER TABLE addresses ADD CONSTRAINT MINIMO_ADD CHECK (CHAR_LENGTH(name) = 81 OR CHAR_LENGTH(name) = 90)")
    ...
    connection.execute("CREATE TABLE transactions (name varchar(81) PRIMARY KEY NOT NULL UNIQUE, timestamp varchar(100) NOT NULL, address varchar(90) NOT NULL, tag varchar(27) NOT NULL, bundlehash varchar(100) NOT NULL, bundleindex int NOT NULL, trytes varchar(2673) NOT NULL, idad int, idta int)")
